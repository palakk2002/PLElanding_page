...
export default function ComparisonTable() {
  return (
    <section className="mb-24">
      ...
      >
        <h2 className="text-2xl md:text-3xl font-bold font-heading tracking-tight">Why Choose <span className="text-primary">PLE</span>?</h2>
        <p className="text-white/30 text-[10px] tracking-[0.2em] font-bold uppercase">PLE vs Typical Agency</p>
      </motion.div>
        ...
        <table className="w-full text-left border-collapse min-w-[600px]">
          <thead>
            <tr className="border-b border-white/10">
              ...
              <th className="py-4 px-6 bg-primary/5 text-primary text-sm font-bold tracking-wide rounded-t-xl border-x border-t border-primary/20 text-center w-1/3">PLE</th>
