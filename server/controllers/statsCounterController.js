...
const defaultStats = [
  { value: 5000, suffix: "+", label: "Products Listed", icon: "ShoppingBag", order: 1 },
  { value: 25, suffix: "+", label: "Categories", icon: "Layers", order: 2 },
  { value: 100, suffix: "%", label: "Secure Checkout", icon: "ShieldCheck", order: 3 },
  { value: 24, suffix: "/7", label: "Customer Support", icon: "Headphones", order: 4 }
];
