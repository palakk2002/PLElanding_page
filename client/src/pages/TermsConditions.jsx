    ...
    <div className="min-h-screen bg-app-bg text-app-text pt-32 pb-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          >
            Website Usage Rules & Policies at PLE
          </motion.p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 relative">
          ...
          >
            <section className="text-lg">
              <p>
                Welcome to PLE (Peoples League of Electronics) (“Company,” “we,” “our,” or “us”). By accessing our website www.ple.in, using our services, or accessing the PLE Client Portal, you agree to comply with and be bound by these Terms & Conditions.
              </p>
              <p className="mt-4">
            ...
            <section>
              ...
              <p className="mb-4">PLE (Peoples League of Electronics) is an Information Technology and Business Process Solutions provider operating under Indian law. These Terms govern:</p>
              <ul className="space-y-4 pl-2">
                ...
                <li className="flex items-start">
                  <span className="text-primary mr-3 mt-1 font-bold">•</span>
                  <span>Access to the PLE Client Portal and any associated systems.</span>
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">PLE (Peoples League of Electronics) provides:</p>
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-app-card p-6 rounded-2xl border border-slate-100 dark:border-app-border shadow-sm">
                  ...
                  <p className="text-sm">All source code, designs, documents, dashboards, and related deliverables created by PLE (Peoples League of Electronics) remain the company’s intellectual property until full payment is received. Upon payment completion, ownership of final deliverables transfers to the client, excluding pre-existing code, frameworks, or proprietary tools.</p>
                </div>
                <div className="bg-white dark:bg-app-card p-6 rounded-2xl border border-slate-100 dark:border-app-border shadow-sm">
                  <h3 className="font-bold text-app-text mb-2 text-primary">Trademarks and Branding</h3>
                  <p className="text-sm">PLE (Peoples League of Electronics) trademarks, logos, and brand assets cannot be used without prior written consent.</p>
                </div>
                <div className="bg-white dark:bg-app-card p-6 rounded-2xl border border-slate-100 dark:border-app-border shadow-sm">
                  <h3 className="font-bold text-app-text mb-2 text-primary">Client Data</h3>
                  <p className="text-sm">Client-provided content and data remain the property of the client. PLE only uses such data to deliver services or as legally required.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">Both PLE (Peoples League of Electronics) and the Client agree to:</p>
              <ul className="space-y-4 pl-2">
                <li className="flex items-start">
                  <span className="text-primary mr-3 mt-1 font-bold">•</span>
            ...
            <section>
              ...
              <p className="mb-4">PLE (Peoples League of Electronics) provides services on a best-effort and professional basis, without guaranteeing outcomes beyond the defined scope.</p>
              ...
              <div className="bg-primary/10 p-6 sm:p-8 rounded-2xl border border-primary/20 mt-8 relative overflow-hidden shadow-sm">
                ...
                <p className="relative z-10 text-sm">
                  To the fullest extent permitted by law, PLE (Peoples League of Electronics)’s liability for any damages (direct, indirect, incidental, or consequential) shall not exceed the total fees paid by the client for the specific service within the last 6 months.
                </p>
              </div>
            </section>
              ...
              <div className="bg-white dark:bg-app-card p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-app-border space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@ple.in" className="text-app-text font-semibold hover:text-primary transition-colors">support@ple.in</a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-app-text font-semibold">PLE (Peoples League of Electronics), Pune, Maharashtra, India</p>
                  </div>
                </div>
              </div>
            </section>
