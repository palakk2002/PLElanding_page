        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold text-app-text">The PLE Solution</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl bg-app-bg border border-app-border relative">
              ...
              <p className="text-sm text-app-text-muted italic mb-6">
                "PLE completely transformed our digital presence. Within 3 months, our inbound leads doubled, and the quality of the new website is unmatched."
              </p>
