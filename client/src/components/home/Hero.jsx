        ...
        <div className="max-w-4xl w-full flex flex-col justify-center space-y-8 sm:space-y-10 text-left pt-8 pb-8 sm:py-0">
          ...
          >
            <span className="text-[9.5px] sm:text-xs font-bold text-white/60 sm:text-app-text/50 tracking-[0.25em] sm:tracking-[0.4em] uppercase block mb-2 sm:mb-1">
              {heroData?.tagline || "REAL DEALS. FAST DELIVERY. HAPPY SHOPPING"}
            </span>
          </motion.div>
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            >
                              {heroData?.heading || (
                  <>Shop. Save. Smile.<span className="text-primary">Enjoy.</span></>
                )}
            </motion.h1>
            ...
            >
                {heroData?.subheading || "Discover daily deals, trusted sellers, and curated products across every category. Shop smart, checkout fast, and enjoy easy delivery."}
            </motion.p>
          </div>
          ...
          >
            {heroData?.description || "Your everyday marketplace for electronics, fashion, home essentials, beauty, wellness, sports gear, and more. Compare offers, buy from verified sellers, pay securely, and get support from cart to doorstep."}
          </motion.p>
        </div>
      </motion.div>
