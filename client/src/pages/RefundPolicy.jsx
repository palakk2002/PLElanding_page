    ...
    <div className="min-h-screen bg-app-bg text-app-text pb-24">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            ...
            >
              ...
              <p className="mt-4 text-lg text-slate-600 dark:text-app-text-muted">
                Payments, Refunds & Service Terms at PLE
              </p>
              <div className="mt-6 space-y-4 text-slate-600 dark:text-app-text-muted leading-relaxed">
                <p>
                  At PLE (Peoples League of Electronics), we are committed to delivering high-quality, customized solutions that add measurable value to our clients' businesses. Our services are intellectual and time-based, meaning they involve professional expertise, research, planning, and effort invested from the moment a project begins.
                </p>
                <p>
                  For this reason, our billing and refund policy is designed to maintain fairness, transparency, and mutual respect between PLE (Peoples League of Electronics) and our clients.
                </p>
              </div>
            </motion.div>
      ...
      >
        ...
        <section>
          ...
          <p className="mb-6">This policy applies to all professional services offered by PLE (Peoples League of Electronics), including:</p>
        ...
        <section>
          ...
          <p className="font-bold text-app-text mb-4 text-xl">PLE (Peoples League of Electronics) follows a strict No Refund Policy for all its professional services.</p>
          ...
          <div className="bg-primary/10 p-6 sm:p-8 rounded-2xl border border-primary/20 relative overflow-hidden shadow-sm">
            ...
            <ul className="space-y-4 relative z-10">
              {[
                ...
                'In case of any dissatisfaction, PLE will work collaboratively to review, revise, or realign deliverables within the agreed scope.',
        ...
        <section>
          ...
          <p className="mb-6">Clients may request cancellation by written notice (email to support@ple.in). In such cases:</p>
