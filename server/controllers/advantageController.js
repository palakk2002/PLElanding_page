...
const defaultRows = [
  { feature: "Product Range", vedhunt: "Multiple categories in one cart", typical: "Limited catalog choices", order: 1 },
  { feature: "Pricing", vedhunt: "Clear deals and visible savings", typical: "Hidden fees at checkout", order: 2 },
  { feature: "Sellers", vedhunt: "Verified sellers and ratings", typical: "Limited seller transparency", order: 3 },
  { feature: "Checkout", vedhunt: "Fast, secure payment flow", typical: "Long and confusing forms", order: 4 },
  { feature: "Delivery", vedhunt: "Order updates from cart to doorstep", typical: "Unclear delivery timelines", order: 5 },
  { feature: "Returns", vedhunt: "Easy return and support process", typical: "Complicated return steps", order: 6 },
  { feature: "Support", vedhunt: "Help available when you need it", typical: "Slow ticket responses", order: 7 }
];
