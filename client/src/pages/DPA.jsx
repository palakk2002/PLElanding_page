...
const dpaSections = [
  ...
  },
  {
    ...
    content: "PLE retains client data only as long as necessary for the project or as required by law.\n\nUpon completion or termination of the engagement:\n• All personal data will be securely deleted, anonymized, or returned to the Client.\n• Backup copies will be purged within 30 to 60 days unless required for legal compliance."
  },
  {
    title: "9. Data Subject Rights",
    content: "PLE assists the Client in fulfilling requests from data subjects, including:\n• Access, correction, or deletion of their personal data.\n• Restriction or objection to processing.\n• Data portability (where applicable).\n\nPLE shall not respond directly to such requests without prior approval from the Client."
  },
  {
    title: "10. International Data Transfers",
    content: "If data is transferred outside India (e.g., hosting or cloud services), PLE ensures:\n• The transfer complies with applicable legal safeguards.\n• Only GDPR-compliant cloud providers (e.g., AWS, Azure, GCP) are used.\n• Data remains encrypted during and after transfer."
  },
  {
    title: "11. Audit and Compliance",
    content: "• PLE will make available all information necessary to demonstrate compliance.\n• The Client may, upon reasonable notice, audit PLE’s data handling procedures (once per year).\n• PLE will cooperate fully and correct any non-compliance promptly."
  },
  {
    title: "12. Data Breach Notification",
    content: "In the event of an actual or suspected breach:\n1. PLE will notify the Client within 72 hours.\n2. The notice will include: Nature and scope of the breach, Data affected, Steps taken to mitigate risks.\n3. PLE will work closely with the Client to contain and remediate the issue."
  },
  {
    title: "13. Liability",
    content: "PLE (Peoples League of Electronics)’s total liability arising out of data processing shall not exceed the total amount paid by the Client under the service contract during the 6-month period preceding the claim, unless caused by gross negligence or willful misconduct."
  },
  {
    title: "14. Term and Termination",
    content: "This DPA remains in effect:\n• For as long as PLE processes data on behalf of the Client; or\n• Until the termination of all service agreements.\n\nUpon termination:\n• PLE will delete or return all client data (as per Section 8).\n• Any surviving confidentiality and security obligations remain binding."
  },
  {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600 dark:text-app-text-muted mb-8 leading-relaxed">
                This Data Processing Agreement (“Agreement” or “DPA”) forms an integral part of the Service Agreement, Statement of Work (SOW), or Master Services Agreement executed between PLE (Peoples League of Electronics) and our Clients.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="mailto:support@ple.in" className="btn-primary flex justify-center text-center">
        ...
        >
          ...
          <div className="mt-12 p-6 bg-primary/10 rounded-2xl border border-primary/20">
            ...
            <p className="text-slate-600 dark:text-app-text-muted mb-4">
              By signing a Service Agreement or engaging PLE (Peoples League of Electronics)’s services, the Client acknowledges that they have reviewed and accepted this Data Processing Agreement. This DPA forms part of the binding contractual relationship between PLE and the Client.
            </p>
            <p className="font-semibold text-primary">
              PLE (Peoples League of Electronics) is committed to protecting the integrity, confidentiality, and security of all client data — ensuring full compliance with Indian and international data protection laws.
            </p>
          </div>
        </motion.div>
      </section>
