...
import { Check, ArrowRight, ShoppingBag, Sparkles, Truck } from 'lucide-react';

const serviceCategories = [
  {
    title: "Daily Deals",
    icon: ShoppingBag,
    description: "Fresh savings across everyday shopping essentials.",
    ...
    tiers: {
      starter: {
        ...
        period: "",
        features: [
          "Limited-time product discounts", 
      ...
      growth: {
        ...
        period: "",
        features: [
          "Bundle savings on top categories", 
          "Extra coupon-friendly offers", 
          "Fast delivery eligible picks", 
      ...
      enterprise: {
        ...
        period: "",
        features: [
          "Premium collections and launches", 
          "Best-value festive offers", 
          "Exclusive marketplace coupons", 
          "Early access sale drops"
        ]
      }
    }
  },
  {
    ...
    icon: Sparkles,
    description: "Extra perks for frequent shoppers and families.",
    ...
    tiers: {
      starter: {
        ...
        features: [
          ...
          "Wishlist and cart reminders", 
          "Standard support access", 
          "Regular coupon alerts"
        ]
      },
      growth: {
        price: "Plus",
      ...
      enterprise: {
        ...
        features: [
          ...
          "Top-tier reward benefits", 
          "Priority issue resolution", 
          "Exclusive seasonal coupons"
        ]
      }
    }
  },
  {
    ...
    icon: Truck,
    description: "Flexible shipping choices for every order size.",
    ...
    tiers: {
      ...
      enterprise: {
        ...
        period: "/mo",
        features: [
          "Large-cart shipping support", 
          "Category-wise delivery planning", 
    ...
    <section className="pt-10 pb-2 px-4 bg-app-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-6 space-y-2">
          ...
          >
            Smart <span className="text-primary">Deals & Rewards</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
