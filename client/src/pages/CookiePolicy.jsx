        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 relative">
          ...
          >
            <section className="text-lg">
              <p>
                PLE (Peoples League of Electronics) ("we", "us", or "our") uses cookies and similar tracking technologies to track activity on our service and hold certain information. This Cookie Policy explains what cookies are, how we use them, and your choices regarding their use.
              </p>
            </section>
