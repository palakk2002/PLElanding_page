      ...
      const initialData = [
        {
          ...
          clientUrl: 'https://example.com/electronics',
          category: 'development',
          tagline: 'Smart gadgets and everyday tech deals',
          description: 'A curated electronics collection featuring phones, accessories, audio gear, and smart devices from trusted sellers with secure checkout and delivery tracking.',
          tags: ['Mobiles', 'Audio', 'Accessories', 'Smart Devices'],
        ...
        },
        {
          ...
          clientUrl: 'https://example.com/home-living',
          category: 'automation',
          tagline: 'Comfort, decor, kitchen, and storage',
          description: 'A practical home collection built around decor, bedding, kitchen helpers, storage, and daily-use products that make everyday living smoother.',
          tags: ['Decor', 'Kitchen', 'Bedding', 'Storage'],
          image: 'https://vedhunt.in/wp-content/uploads/2026/01/rinn3.webp',
          statLabel: 'Value Packs',
          statValue: '25+ Picks',
          icon: 'Database',
          displayOrder: 2
        },
        {
          ...
          clientUrl: 'https://example.com/fashion',
          category: 'development',
          tagline: 'Fresh styles for every season',
          description: 'A fashion-focused collection featuring apparel, footwear, and accessories with easy browsing, clear product details, and simple return support.',
          tags: ['Apparel', 'Footwear', 'Accessories', 'Seasonal'],
        ...
        },
        {
          ...
          clientUrl: 'https://example.com/beauty-wellness',
          category: 'marketing',
          tagline: 'Self-care essentials and trusted brands',
          description: 'A beauty and wellness collection for skincare, haircare, grooming, and personal care with trusted sellers and daily savings.',
          tags: ['Skincare', 'Haircare', 'Grooming', 'Wellness'],
          image: 'https://vedhunt.in/wp-content/uploads/2026/01/mumbai3.webp',
          statLabel: 'Customer Picks',
          statValue: '4.8/5',
          icon: 'Share2',
          displayOrder: 4
        }
