...
export const SERVICE_DETAILS_DATA = {
  'website-development': {
    ...
    testimonial: {
      feedback: "Working with PLE was extremely professional. They took our complex corporate requirements and transformed them into a beautiful, lightning-fast React portal that load instantly. Absolutely outstanding work!",
      author: "Reshma S.",
  ...
  'accounting-financial-services': {
    ...
    testimonial: {
      feedback: "Working with PLE has given us massive relief. They managed our complex input tax credits and TDS filings with absolute precision. Our bookkeeping is finally in pristine shape!",
      author: "Piyush K.",
  ...
  'mis-reporting-services': {
    ...
    testimonial: {
      feedback: "Working with PLE was extremely professional. They took our complex reporting workflow and transformed it into a fully automated Power BI dashboard. Saves our department 15 hours every single week.",
      author: "Piyush K.",
      role: "Finance Director",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=150&h=150&fit=crop"
    }
